...
Экзамен будет проходить в письменном виде в удаленном формате. Каждому на почту будет выслан билет, у вас будет 90 минут на оформление письменного ответа. Билет будет включать в себя один вопрос по основам DL, второй по PyTorch и типам решаемых задач, третий по практической части.  
